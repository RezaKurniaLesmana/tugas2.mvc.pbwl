...
class pelanggan extends Model
{
      ...
      public function simpan()
      {
            ...
            $ktp = $_POST['pel_ktp'];
            $seri = $_POST['pel_seri'];
            $ukuran = $_POST['pel_ukuran'];
            $aktif = $_POST['pel_aktif'];
            $golongan = $_POST['pel_id_gol'];
            $user = $_POST['pel_id_user'];

            $sql = "INSERT INTO tb_pelanggan (pel_id_gol,pel_no,pel_nama,pel_alamat,pel_hp,pel_ktp,pel_seri,pel_ukuran,pel_aktif,pel_id_user) VALUES (:pel_id_gol, :pel_no, :pel_nama, :pel_alamat, :pel_hp, :pel_ktp, :pel_seri, :pel_ukuran, :pel_aktif, :pel_id_user)";
            ...
            $stmt->bindParam(":pel_ukuran", $ukuran);
      ...
      public function update(){
            ...
            $pel_ukuran = $_POST['pel_ukuran'];
            $pel_aktif = $_POST['pel_aktif'];
            $pel_golongan = $_POST['pel_id_gol'];
            $pel_user = $_POST['pel_id_user'];
            $pel_id = $_POST['pel_id'];

            $sql = "UPDATE tb_pelanggan SET pel_id_gol=:pel_id_gol, pel_no=:pel_no, pel_nama=:pel_nama, pel_alamat=:pel_alamat, pel_hp=:pel_hp, pel_ktp=:pel_ktp, pel_seri=:pel_seri, pel_ukuran=:pel_ukuran, pel_aktif=:pel_aktif, pel_id_user=:pel_id_user WHERE pel_id=:pel_id";
            $stmt = $this->db->prepare($sql);
            ...
            $stmt->bindParam(":pel_ukuran", $pel_ukuran);
